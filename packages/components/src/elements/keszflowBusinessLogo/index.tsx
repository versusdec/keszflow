...
function getColor(color: string | undefined, palette: any) {
  let themeColor
  const arr: string[] | string | undefined = color && color.split('.')
  if (arr?.length && Array.isArray(arr)) {
    while (arr.length) {
      palette = arr.length && palette[arr.shift() as keyof typeof palette]
    }
    themeColor = palette
  } else {
    themeColor = color
  ...
  >
    ...
    >
      <g fillRule="evenodd" clipRule="evenodd">
        <path
          fill={getColor(colorMain, palette)}
          d="M28.4 0h63.4c15.6 0 28.3 12.7 28.3 28.3v63.4c0 15.6-12.7 28.3-28.3 28.3H28.4C12.8 120 .1 107.3.1 91.7V28.3C.1 12.7 12.8 0 28.4 0z"
        />
        <path
          fill={getColor(colorSecondary, palette)}
          d="m.1 96.6 32.7-27.8c3.3-2.8 7.2-4 11.5-3.1l30.2 6.8c2.8.6 5.7-.7 7-3.4l26.7-52-35.8 26.6c-3.1 2.2-6.7 3.1-10.4 2.1l-27.4-6.5c-3.5-.8-6.7-.3-9.7 1.5L.1 56.3v40.3z"
        />
      </g>
      <g fill={getColor(colorMain, palette)}>
